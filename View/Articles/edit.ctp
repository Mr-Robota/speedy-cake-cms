...
var numCustomFields = <?php echo $numArticlefields; ?>;
...
function deleteImageSrc(id) {
	window.location.href = '<?php echo Configure::read('SpeedyCake.url') ."/admin/articles/deleteImageSrc/"; ?>' + id;
}
	...
	<div class="well">
        	...
        	<div class="span12">
                <div class="well" style="background-color:#E1E1E1;">
                    ...
                    <label class="checkbox">
						...
						$checked = $this->SpeedyCake->checkCategorieSelected($id,$item["Categorie"]["id"]);
						
						if ($checked>0) $selected = true;
						else $selected = false;
        ...
        <div class="row-fluid">
            <div class="well" style="background-color:#E1E1E1;margin-top:10px;">
                ...
                <div id="customFields">
                	<?php $i= 0; ?>
                	<?php if ($numArticlefields>0) { ?>
                    <?php foreach ($articlefields as $articlefield): ?>
                        <div class="row-fluid" id="field_<?php echo $i; ?>">
                        <div class="span5">
                        <p><strong><?php echo __('Key'); ?></strong></p>
                        <input type="text" class="input-block-level" id="Articlefield.<?php echo $i; ?>.key" name="data[Articlefield][<?php echo $i; ?>][key]" value="<?php echo $articlefield['Articlefield']['key']; ?>">
                        </div>
                        <div class="span5">
                        <p><strong><?php echo __('Value'); ?></strong></p>
                        <input type="text" class="input-block-level" id="Articlefield.<?php echo $i; ?>.key" name="data[Articlefield][<?php echo $i; ?>][value]" value="<?php echo $articlefield['Articlefield']['value']; ?>">
                        </div>
                        <div class="span2">
