...
$(document).ready(function() {
	...
	$("#btnSave").click(function() {
		...
		type: "POST",
		async: false,
		url: "<?php echo Configure::read('SpeedyCake.url'); ?>/admin/pages/titleIsUnique",
		data: { title: title}
		})
...
<?php echo $this->Form->create('Page',array('action' => 'add','type'=>'file')); ?>

<div class="span9">

	<div class="well">
    
		<h1><?php echo __('Add new page'); ?></h1>
