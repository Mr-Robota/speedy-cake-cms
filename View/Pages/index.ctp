	...
	<div class="well">
		...
		<div class="row-fluid databtn">
			<div class="span12 visible-desktop visible-tablet">
				<a href="<?php echo Configure::read('SpeedyCake.url'); ?>/admin/pages/add" class="btn btn-inverse btn-large"><i class="icon-plus icon-white"></i> <?php echo __('New Page'); ?></a>
			</div>
			<div class="span12 visible-phone">
				<a href="<?php echo Configure::read('SpeedyCake.url'); ?>/admin/pages/add" class="btn btn-inverse btn-block"><i class="icon-plus icon-white"></i> <?php echo __('New Page'); ?></a>
			</div>
		</div>
		...
		<div class="row-fluid datarow visible-desktop visible-tablet">
			<div class="span1">
				<p><?php echo $row['Page']['id']; ?></p>
			</div>
            <div class="span3">
				<p><?php echo $row['Page']['title']; ?></p>
			</div>
            <div class="span2">
				<p><strong><?php echo $this->SpeedyCake->getUsername($row['Page']['user_id']); ?></strong></p>
			</div>
			<div class="span2">
				<p>
				<?php
                
					if ($row['Page']['status']==0) echo '<span class="label">' .__('Draft') .'</span>';
					if ($row['Page']['status']==1) echo '<span class="label label-success">' .__('Published') .'</span>';
				
				?>
                </p>
			</div>
			<div class="span2">
				<p><?php echo $row['Page']['created']; ?></p>
			</div>
			<div class="span2 btnactions">
				<a href="<?php echo Configure::read('SpeedyCake.url'); ?>/admin/pages/edit/<?php echo $row['Page']['id']; ?>" rel="tooltip" data-original-title="<?php echo __('Edit'); ?>"><i class="icon-pencil"></i></a>
				<a href="javascript:deleteRow('pages',<?php echo $row['Page']['id']; ?>);" rel="tooltip" data-original-title="<?php echo __('Delete'); ?>"><i class="icon-trash"></i></a>
			</div>
		</div>
		<div class="row-fluid datarow visible-phone">
			<ul class="unstyled inline">
				<li><p><?php echo $row['Page']['id']; ?></p></li>
                <li><p><?php echo $row['Page']['title']; ?></p></li>
                <li><p><strong><?php echo $this->SpeedyCake->getUsername($row['Page']['user_id']); ?></strong></p></li>
				<li><p>
                <?php
				...
				<li><p><?php echo $row['Page']['created']; ?></p></li>
				<li>
                	<a href="<?php echo Configure::read('SpeedyCake.url'); ?>/admin/pages/edit/<?php echo $row['Page']['id']; ?>" rel="tooltip" data-original-title="<?php echo __('Edit'); ?>"><i class="icon-pencil"></i></a>
					<a href="javascript:deleteRow('pages',<?php echo $row['Page']['id']; ?>);" rel="tooltip" data-original-title="<?php echo __('Delete'); ?>"><i class="icon-trash"></i></a>
                </li>
